        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
            ...
            <div style={{ display: "inline-flex", flexDirection: "column", justifyContent: "center", width: "fit-content" }}>
              <div style={{ background: "linear-gradient(to right, #FCD34D, #F59E0B, #D97706)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: 900, fontSize: 18, letterSpacing: 0.5, filter: "drop-shadow(0 2px 10px rgba(245,158,11,0.3))", lineHeight: 1.1, whiteSpace: "nowrap", width: "max-content" }}>DIVYAKSHI CABS</div>
              <div style={{ color: "#F8FAFC", fontSize: 7.5, fontWeight: 700, opacity: 0.85, marginTop: 2, textAlign: "justify", textAlignLast: "justify", MozTextAlignLast: "justify", width: "100%" }}>UNIT OF DIVYAKSHI TOURS &amp; TRAVELS</div>
            </div>
          </div>
